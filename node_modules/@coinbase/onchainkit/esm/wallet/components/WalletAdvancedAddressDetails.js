...
function WalletAdvancedAddressDetails() {
  ...
  return /*#__PURE__*/jsxs("div", {
    className: cn('mt-2 flex flex-col items-center justify-center', color.foreground, text.body, animations.content),
    children: [/*#__PURE__*/jsx("div", {
      ...
      children: [/*#__PURE__*/jsx("button", {
        ...
        type: "button",
        onClick: handleCopyAddress,
        className: cn(pressable.alternate, text.legal, color.foreground, border.default, border.radius, 'absolute top-full right-0 z-10 mt-0.5 px-1.5 py-0.5 opacity-0 transition-opacity group-hover:opacity-100'),
        "aria-live": "polite",
