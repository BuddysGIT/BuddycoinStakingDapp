...
function WalletAdvancedQrReceive() {
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    className: cn(color.foreground, text.headline, 'flex flex-col items-center justify-between', 'h-full w-full', 'px-4 pt-3 pb-4', isQrClosing ? 'fade-out slide-out-to-left-5 animate-out fill-mode-forwards ease-in-out' : 'fade-in slide-in-from-left-5 linear animate-in duration-150'),
    onAnimationEnd: handleAnimationEnd,
    children: [/*#__PURE__*/jsxs("div", {
      className: "flex h-[34px] w-full flex-row items-center justify-between",
