...
function Dialog({
  ...
  const dialog = /*#__PURE__*/jsx("div", {
    className: cn(componentTheme, 'fixed inset-0 z-50 flex items-center justify-center', 'bg-black/50 transition-opacity duration-200', 'fade-in animate-in duration-200'),
